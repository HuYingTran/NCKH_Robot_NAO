...
def detect_canh(anh):
    ...
    lines = cv2.HoughLinesP(edges, 1, np.pi / 180, threshold=10, minLineLength=50, maxLineGap=100)
    ...
    frame = cv2.circle(frame, (center_x, center_y), 10, (0, 255, 0), -1)
